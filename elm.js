...
Elm.Main.make = function (_elm) {
   ...
   var filterColors = F3(function (colors,gameSize,randomInt) {
      var seed = $Random.initialSeed(randomInt);
      var colorArray = $Array.fromList(allColors);
      var shuffled = $Random$Array.shuffle(colorArray);
      var listShuffled = $Array.toList($Basics.fst(A2($Random.generate,shuffled,seed)));
      var listValues = A2($List.take,gameSize,listShuffled);
      return listValues;
   });
